...
const BusRushPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold text-center">Bus Rush: An Endless Running Adventure</h1>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Swipe Left/Right:</strong> Change lanes to dodge oncoming obstacles.
        </li>
        <li>
          <strong>Swipe Up:</strong> Jump over obstacles to keep your momentum.
        </li>
        <li>
          <strong>Swipe Down:</strong> Slide under obstacles and barriers.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Diverse Environments:</strong> Run through multiple scenarios including city streets, subways, forests, and beaches.
        </li>
        <li>
          <strong>Multiple Characters & Customization:</strong> Unlock and choose from a variety of characters, each with unique abilities and upgrade options.
        </li>
        <li>
          <strong>Power-ups & Boosters:</strong> Enhance your run with power-ups such as coin magnets, jetpacks, super jumps, and score multipliers.
        </li>
        <li>
          <strong>Innovative Challenges:</strong> Daily missions, tournaments, and dynamic obstacles keep the gameplay fresh and engaging.
        </li>
        <li>
          <strong>Intuitive Swipe Controls:</strong> Easy-to-learn mechanics make it accessible to players of all ages.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Master the Controls:</strong> Practice swiping accurately to avoid obstacles and react to sudden changes in the environment.
        </li>
        <li>
          <strong>Plan Your Route:</strong> Keep an eye on the track and anticipate upcoming obstacles to choose the safest lane.
        </li>
        <li>
          <strong>Upgrade Power-ups:</strong> Invest coins in enhancing your power-ups to maximize their benefits during your runs.
        </li>
        <li>
          <strong>Collect Coins:</strong> Prioritize gathering coins to unlock new characters and boost your overall performance.
        </li>
      </ul>
