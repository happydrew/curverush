...
const ClusterRushPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold text-center">Cluster Rush: A High-Octane Platformer</h1>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Movement:</strong> Use the LEFT and RIGHT arrow keys or A and D keys to move your character laterally.
        </li>
        <li>
          <strong>Jump:</strong> Press the SPACEBAR or J key to jump. Holding the key allows your character to climb onto the trucks.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Immersive First-Person Perspective:</strong> Experience the rush of high-speed platforming from a unique first-person view.
        </li>
        <li>
          <strong>Dynamic Obstacles:</strong> Dodge falling objects, explosive hazards, and uneven terrains that challenge your every move.
        </li>
        <li>
          <strong>Rhythmic Gameplay:</strong> The game's pace syncs with dynamic music beats, enhancing timing and coordination.
        </li>
        <li>
          <strong>35 Challenging Levels:</strong> Progress through a series of levels with escalating difficulty to master your skills.
        </li>
        <li>
          <strong>Innovative Climbing Mechanics:</strong> Utilize the sides of trucks to climb, adding a creative twist to traditional platforming.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Master the Controls:</strong> Practice precise timing for jumps and climbs. Familiarity with the controls is key to staying on track.
        </li>
        <li>
          <strong>Anticipate Obstacles:</strong> Watch for incoming hazards like falling crates or explosive collisions. Learning patterns will improve your reaction time.
        </li>
        <li>
          <strong>Use Rhythmic Cues:</strong> Let the dynamic soundtrack guide your movements. Syncing your jumps with the beat can help maintain momentum.
        </li>
        <li>
          <strong>Stay Focused:</strong> With the fast pace of Cluster Rush, a split-second distraction can end your run. Keep your eyes on the path ahead.
        </li>
      </ul>
