...
const CarRushPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold text-center">Car Rush: An Adrenaline-Fueled Racing Experience</h1>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Arrow Keys / WASD:</strong> Use the up arrow or ‘W’ key to accelerate, down arrow or ‘S’ key to brake, and left/right arrow keys or ‘A’ and ‘D’ keys to steer.
        </li>
        <li>
          <strong>Touch Controls:</strong> On mobile devices, tap the gas and brake pedals for acceleration and braking, and use on-screen arrows for steering.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Time-Based Challenges:</strong> Each level has a countdown timer, requiring players to race against time.
        </li>
        <li>
          <strong>Obstacle Avoidance:</strong> Dodge cars, barriers, and sudden turns to maintain speed and avoid crashes.
        </li>
        <li>
          <strong>Multiple Tracks:</strong> Experience diverse tracks, each with increasing difficulty and unique road layouts.
        </li>
        <li>
          <strong>Realistic Speed Dynamics:</strong> Smooth handling and acceleration mechanics make the game feel immersive.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Master the Turns:</strong> Use controlled braking to take sharp corners without losing momentum.
        </li>
        <li>
          <strong>Stay on the Fast Lane:</strong> Driving efficiently on the optimal path helps maintain top speed.
        </li>
        <li>
          <strong>Anticipate Traffic:</strong> Plan ahead to weave through traffic smoothly without last-second moves.
        </li>
        <li>
          <strong>Boost When Possible:</strong> Look for speed zones or boosts to gain an advantage over time.
        </li>
      </ul>

      <h2 className="text-2xl font-semibold">Watch Gameplay</h2>
